...
export default function Footer() {
  ...
  return (
    <footer style={{
      background: '#f0ece3', color: '#5a5550',
      ...
      <div style={{
        ...
        paddingBottom: '1.5rem', borderBottom: '1px solid var(--light-rule)',
      }}>
        {/* Brand */}
        <div>
          <span style={{
      ...
      <div style={{
        ...
        <span>
          {isPortfolio ? (
            <>字體授權請前往{' '}
              <Link href="/fonts" style={{ color: '#1a1714', textDecoration: 'underline', textUnderlineOffset: '0.2em' }}>字趣 fontsfun</Link>
            </>
          ) : (
            <>設計接案請前往{' '}
