...
const works: Work[] = [
  { cat: 'brand',     workCat: 'Brand Visual',     span: 'wide',
    title: '字趣 雲書體 主視覺',
    desc: '字趣 fontsfun 2025 年度新作「雲書體」發表主視覺。以青空、雲形、墨痕構成飄逸書寫意象，強調「圓潤筆觸 · 現代優雅」的字型氣質，並整合早鳥試用問卷活動資訊。',
    result: '2025 年度新字型發表＋早鳥試用活動視覺',
    img: '/images/works/brand/fontsfun-cloudbook.jpg',
    alt: '字趣 雲書體 字型發表主視覺' },

  { cat: 'editorial', workCat: 'Editorial Design',
    title: '馬若瑟的文學世界',
  ...
  { cat: 'brand',     workCat: 'OOH Campaign',
    title: '正官庄 蔘享新年公車',
    desc: '正官庄「蔘享新年・臺品之選深意極現」公車車體廣告 KV 設計。整合品牌代言人許光漢形象、產品全系列陳列、新春節慶氛圍，於大南汽車 085-FR 車線曝光。',
  ...
  { cat: 'packaging', workCat: 'Packaging Design',
  ...
  { cat: 'brand',     workCat: 'Key Visual',       span: 'tall',
    title: '正官庄 EVERYTIME',
  ...
  { cat: 'brand',     workCat: 'Promo Campaign',
    title: '正官庄 破盤日 KV',
    desc: '夏季「破盤日 7.1–7.31」季節促銷主視覺。以紅色爆破字體、立體浮雕標題搭配代言人實拍，建立超殺折扣的視覺張力，並整合 9 款主打商品的價格資訊。',
    result: '季節促銷主視覺＋商品 DM 整合',
    img: '/images/works/brand/chkj-flash-sale-dm.jpg',
    alt: '正官庄 破盤日 DM' },

  { cat: 'type',      workCat: 'Character Design',
    title: '餅乾人 字符組',
  ...
  { cat: 'brand',     workCat: 'Brand Concept',
    title: 'IDEA 創意團隊概念視覺',
  ...
  { cat: 'packaging', workCat: 'Print Collateral',
    title: '正官庄 抽獎券',
...
export default function PortfolioPage() {
  return (
    <>
      ...
      {/* WORKS */}
      <section id="works" style={{ padding: '6rem 4rem' }}>
        <div style={{
          display: 'flex', alignItems: 'baseline', gap: '1.5rem',
          marginBottom: '4rem', paddingBottom: '1rem',
