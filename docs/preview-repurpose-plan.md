...
原本 `/preview` 路由是為了給「莫奇利創意設計」首頁做 redesign 試作。
2026-04-22 方向調整：**不做莫奇利創意設計首頁 redesign**。
...
- **Hero 文案**：「莫奇利創意設計 / Mochili Creative Design / 以字為核心的創意設計工作室」
  → 換成字趣主張，例如「字 趣 / fontsfun / 繁體中文字體設計」之類
- **Concept「關於莫奇利」** → 換成「關於字趣」的品牌敘事
